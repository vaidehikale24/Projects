...
void man(char *name)
{
    ...
    if(strcmp(name, "create") == 0)
    {
        ...
        printf("Usage: read File_name Permission\n");
    }
...
void DisplayHelp()
{
    ...
    printf("read: To read the conents from file\n");
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            if(strcmp(command[0], "stat") == 0)
            {
                ...
                if(ret == -2)
                    printf("ERROE: There is no such file\n");
                continue;
            }
        ...
        else if(count == 3)
        {
            ...
            if(strcmp(command[0], "read") == 0)
            {
                ...
                if(ret == -1)
                    printf("ERROR: File not exxisting\n");
                if(ret == -2)
                    printf("ERROR: Permission denied\n");
                if(ret == -3)
